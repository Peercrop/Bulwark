...
RESOURCES += src/qt/peercrop.qrc src/qt/peercrop_locale.qrc

TRANSLATIONS += src/qt/locale/peercrop_bg.ts \
                src/qt/locale/peercrop_de.ts \
                src/qt/locale/peercrop_en.ts \
                src/qt/locale/peercrop_es.ts \
                src/qt/locale/peercrop_fi.ts \
                src/qt/locale/peercrop_fr.ts \
                src/qt/locale/peercrop_it.ts \
                src/qt/locale/peercrop_ja.ts \
                src/qt/locale/peercrop_pl.ts \
                src/qt/locale/peercrop_pt.ts \
                src/qt/locale/peercrop_ru.ts \
                src/qt/locale/peercrop_sk.ts \
                src/qt/locale/peercrop_sv.ts \
                src/qt/locale/peercrop_vi.ts \
                src/qt/locale/peercrop_zh_CN.ts \
                src/qt/locale/peercrop_zh_TW.ts
